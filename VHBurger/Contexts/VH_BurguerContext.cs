...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CategoriaID).HasName("PK__Categori__F353C1C598374487");
        ...
        {
            entity.HasKey(e => e.Log_AlteracaoProdutoID).HasName("PK__Log_Alte__D06C51B7D342C54A");
        ...
        {
            entity.HasKey(e => e.ProdutoID).HasName("PK__Produto__9C8800C3F13F74F9");
            ...
            entity.HasIndex(e => e.Nome, "UQ__Produto__7D8FE3B22DF77B9F").IsUnique();
        ...
        {
            entity.HasKey(e => e.PromocaoID).HasName("PK__Promocao__254B583DE682EBF9");
        ...
        {
            entity.HasKey(e => e.UsuarioID).HasName("PK__Usuario__2B3DE79832B4C16D");

            entity.ToTable(tb => tb.HasTrigger("trg_ExclusaoUsuario"));

            entity.HasIndex(e => e.Email, "UQ__Usuario__A9D1053430820F0A").IsUnique();
